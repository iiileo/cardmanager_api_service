...
func (*Store) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case store.FieldID, store.FieldOwnerUserID, store.FieldStatus:
			values[i] = new(sql.NullInt64)
		case store.FieldName, store.FieldCity, store.FieldAddress, store.FieldOpenTime, store.FieldCloseTime, store.FieldBizType, store.FieldInviteCode:
...
func (_m *Store) String() string {
	...
	builder.WriteString(_m.OpenTime)
	builder.WriteString(", ")
	builder.WriteString("close_time=")
	builder.WriteString(_m.CloseTime)
	builder.WriteString(", ")
