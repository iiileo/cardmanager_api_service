...
func (_q *MemberQuery) QueryCards() *MemberCardQuery {
...
func (_q *MemberQuery) QueryLedgers() *LedgerEntryQuery {
...
func (_q *MemberQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MemberQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *MemberQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MemberQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *MemberQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *MemberQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MemberQuery) WithCards(opts ...func(*MemberCardQuery)) *MemberQuery {
	query := (&MemberCardClient{config: _q.config}).Query()
...
func (_q *MemberQuery) WithLedgers(opts ...func(*LedgerEntryQuery)) *MemberQuery {
	query := (&LedgerEntryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MemberQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Member, error) {
	...
	if query := _q.withCards; query != nil {
		if err := _q.loadCards(ctx, query, nodes,
			func(n *Member) { n.Edges.Cards = []*MemberCard{} },
			func(n *Member, e *MemberCard) { n.Edges.Cards = append(n.Edges.Cards, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLedgers; query != nil {
		if err := _q.loadLedgers(ctx, query, nodes,
			func(n *Member) { n.Edges.Ledgers = []*LedgerEntry{} },
			func(n *Member, e *LedgerEntry) { n.Edges.Ledgers = append(n.Edges.Ledgers, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MemberQuery) loadCards(ctx context.Context, query *MemberCardQuery, nodes []*Member, init func(*Member), assign func(*Member, *MemberCard)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(membercard.FieldMemberID)
	}
	query.Where(predicate.MemberCard(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(member.CardsColumn), fks...))
	}))
...
func (_q *MemberQuery) loadLedgers(ctx context.Context, query *LedgerEntryQuery, nodes []*Member, init func(*Member), assign func(*Member, *LedgerEntry)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Member)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ledgerentry.FieldMemberID)
	}
	query.Where(predicate.LedgerEntry(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(member.LedgersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
