...
func (_u *RefreshTokenUpdate) SetDeviceID(v string) *RefreshTokenUpdate {
	_u.mutation.SetDeviceID(v)
	return _u
}

// SetNillableDeviceID sets the "device_id" field if the given value is not nil.
func (_u *RefreshTokenUpdate) SetNillableDeviceID(v *string) *RefreshTokenUpdate {
	if v != nil {
		_u.SetDeviceID(*v)
	}
	return _u
...
func (_u *RefreshTokenUpdate) ClearDeviceID() *RefreshTokenUpdate {
...
func (_u *RefreshTokenUpdate) check() error {
	...
	if v, ok := _u.mutation.DeviceID(); ok {
		if err := refreshtoken.DeviceIDValidator(v); err != nil {
			return &ValidationError{Name: "device_id", err: fmt.Errorf(`ent: validator failed for field "RefreshToken.device_id": %w`, err)}
		}
	}
	...
	if v, ok := _u.mutation.IP(); ok {
		if err := refreshtoken.IPValidator(v); err != nil {
			return &ValidationError{Name: "ip", err: fmt.Errorf(`ent: validator failed for field "RefreshToken.ip": %w`, err)}
		}
	}
	return nil
}
...
// SetDeviceID sets the "device_id" field.
func (_u *RefreshTokenUpdateOne) SetDeviceID(v string) *RefreshTokenUpdateOne {
	_u.mutation.SetDeviceID(v)
	return _u
}

// SetNillableDeviceID sets the "device_id" field if the given value is not nil.
func (_u *RefreshTokenUpdateOne) SetNillableDeviceID(v *string) *RefreshTokenUpdateOne {
	if v != nil {
		_u.SetDeviceID(*v)
	}
	return _u
